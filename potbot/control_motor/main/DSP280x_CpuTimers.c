...
void Init_ISR(void)
{
	...
	//PieVectTable.ADCINT = &SCI_b_Interrupt; // ADC interrupt
	//PieVectTable.SCIRXINTB = &SCI_b_Interrupt; // SCI_b interrupt
	...
	//PieCtrlRegs.PIEIER9.bit.INTx3 = 1; //SCI_b_rx interrupt
	//PieCtrlRegs.PIEIER9.bit.INTx4 = 1; //SCI_b_tx interrupt
